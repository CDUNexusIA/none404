...
def handle_attack_command(message):
    ...
    bot.send_message(message.chat.id, f'¡Ataque en proceso! Método: {metodo}, Objetivo: {objetivo}, Tiempo: {tiempo}, Hilos: {hilos}')
    ...
    try:
        ...
        bot.send_message(message.chat.id, f'Ocurrió un error al ejecutar el comando: {str(e)}')
    ...
    bot.send_message(message.chat.id, "¡Ataque finalizado!")
